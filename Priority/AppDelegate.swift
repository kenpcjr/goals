...
//  Priority
//
//  Created by Kenneth Cooke on 7/25/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if dataStore.userContainer[0].goalInProgress != nil {
            ...
            let goalStatusViewController = storyboard.instantiateViewController(withIdentifier: "goalStatusNav")
        ...
        if dataStore.userContainer[0].goalInProgress == nil && dataStore.userContainer[0].goalsComplete?.count != 0 {
            ...
            let newGoalViewController = storyboard.instantiateViewController(withIdentifier: "newGoal")
